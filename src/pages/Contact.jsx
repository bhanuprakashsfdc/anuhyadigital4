...
import { Mail, Phone, MapPin, Send, MessageSquare, Share2, GitBranch, Bird, Terminal, CheckCircle2 } from 'lucide-react';
...
const Contact = () => {
  ...
  const contactChannels = [
    { icon: Mail, label: "Email Us", value: "hello@anuhya.digital" },
    { icon: Phone, label: "Call Directly", value: "+1 800-AN-DIGITAL" }
  ];
      ...
      <section className="px-8 py-24 md:py-40 max-w-screen-2xl mx-auto space-y-20">
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            >
              <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-[80px] -mr-32 -mt-32 group-hover:bg-primary/10 transition-colors duration-700" />
                ...
                <form onSubmit={handleSubmit} className="relative space-y-12">
                  <div className="grid md:grid-cols-2 gap-12">
                    <div className="relative group">
                      ...
                      />
                      <label className="absolute left-0 top-4 text-on-surface-variant/60 transition-all peer-focus:text-xs peer-focus:-top-4 peer-focus:text-primary peer-[:not(:placeholder-shown)]:text-xs peer-[:not(:placeholder-shown)]:-top-4 uppercase tracking-widest font-mono text-[0.65rem] font-black">
                        Full Name
                      </label>
                    </div>
                    <div className="relative group">
                  ...
                  <div className="relative group">
                    ...
                    <label className="absolute left-0 -top-4 text-primary uppercase tracking-widest font-mono text-[0.65rem] font-black">
                      Service Interest
                    </label>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between gap-8 pt-6">
                    ...
                    <button 
                      type="submit"
                      className="w-full md:w-auto cyber-gradient text-[#062100] px-12 py-5 rounded-md font-label font-black uppercase text-sm tracking-widest flex items-center justify-center gap-3 hover:scale-105 active:scale-95 transition-all shadow-[0_0_30px_rgba(173,255,133,0.2)]"
                    >
                      Send Inquiry
                      <Send size={16} />
                    </button>
            ...
            >
              ...
              <div className="absolute bottom-10 left-10 p-10 glass-card rounded-xl border border-white/5 space-y-4">
                ...
                <button className="flex items-center gap-3 text-primary font-mono text-[0.6rem] font-black uppercase tracking-widest pt-4 group/btn">
                  <MapPin size={14} className="group-hover/btn:scale-110 transition-transform" />
                  View on Google Maps
                </button>
              </div>
              <div className="absolute top-1/3 left-1/2 w-4 h-4 bg-primary rounded-full animate-ping opacity-20" />
              <div className="absolute top-1/3 left-1/2 w-2 h-2 bg-primary rounded-full shadow-[0_0_20px_#ADFF85]" />
            </motion.div>
          </div>
          ...
          <aside className="lg:col-span-4 space-y-10">
            ...
            <div className="surface-high p-10 rounded-2xl border border-outline-variant/10 space-y-8 shadow-xl">
              ...
              <div className="space-y-4 pt-4">
                ...
                />
                <button className="w-full py-5 border border-primary text-primary rounded-lg font-mono text-[0.65rem] font-black uppercase tracking-[0.3em] hover:bg-primary/10 transition-all active:scale-95">
            ...
            <div className="space-y-4">
              {contactChannels.map((channel, i) => (
                <div key={i} className="surface-low p-8 rounded-xl border border-outline-variant/10 flex items-center gap-6 hover:surface-high transition-all group cursor-pointer">
            ...
            <div className="surface-low p-10 rounded-2xl border border-outline-variant/10 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                {socials.map((social, i) => (
                  <button key={i} className="flex flex-col items-center justify-center p-6 rounded-xl surface-high border border-outline-variant/20 hover:border-primary/40 hover:scale-[1.03] transition-all group">
                    <social.icon size={24} className="text-on-surface-variant group-hover:text-primary mb-3 transition-colors" />
