            ...
            <div key={post.id} className="card-glass overflow-hidden group">
              ...
              <div className="p-6">
                ...
                <h3 className="text-lg font-semibold text-on-surface mb-3 font-headline line-clamp-2 group-hover:text-primary transition-colors duration-300">
                  <a href={post.link} target="_blank" rel="noopener noreferrer" dangerouslySetInnerHTML={{ __html: post.title.rendered }}></a>
                </h3>
                <p className="text-sm text-on-surface-variant leading-relaxed line-clamp-3" dangerouslySetInnerHTML={{ __html: post.excerpt.rendered }}></p>
                <a
                  href={post.link}
                  target="_blank"
